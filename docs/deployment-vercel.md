...
| ----------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Build fails on `prisma generate`                                        | `DATABASE_URL` is missing or unreachable.                                                                                                                                                                             | Confirm the variable is set for the **Production** scope and that `npx prisma migrate deploy` runs cleanly against it (the connection check that also applies the schema).                                                                                                                                                                                                                                                                                                                                                    |
