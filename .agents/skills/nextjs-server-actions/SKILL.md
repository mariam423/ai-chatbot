...
description: Complete Next.js Server Actions system (Next.js 15.5/16). Use when defining Server Actions with 'use server', form handling, useActionState/useFormStatus pending states, optimistic updates, validation with Zod, authorization, file uploads, revalidation after mutations, or next-safe-action integration.
version: 1.0.0
invoked_by: user
user_invocable: true
source: builtin
