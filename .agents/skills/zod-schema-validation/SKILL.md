...
description: Best practices for Zod schema validation and type inference in TypeScript applications. Use when validating data at system boundaries (API, forms, external storage) or deriving TypeScript types from Zod schemas.
version: 1.0.0
invoked_by: user
user_invocable: true
source: builtin
